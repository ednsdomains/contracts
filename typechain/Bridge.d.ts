...
interface BridgeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "TERMINATOR_ROLE()": FunctionFragment;
...
export class Bridge extends BaseContract {
  ...
  functions: {
    ...
    TERMINATOR_ROLE(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    TERMINATOR_ROLE(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    TERMINATOR_ROLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
