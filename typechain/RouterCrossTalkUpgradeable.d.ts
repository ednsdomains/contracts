...
interface RouterCrossTalkUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class RouterCrossTalkUpgradeable extends BaseContract {
  ...
  interface: RouterCrossTalkUpgradeableInterface;
