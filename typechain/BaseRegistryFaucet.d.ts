...
interface BaseRegistryFaucetInterface extends ethers.utils.Interface {
  functions: {
...
export class BaseRegistryFaucet extends BaseContract {
  ...
  interface: BaseRegistryFaucetInterface;
