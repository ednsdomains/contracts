...
async function main() {
  ...
  // ===== Avalanche Fuji ===== //
  const AvalancheProvider = new ethers.providers.JsonRpcProvider("https://rpc.ankr.com/eth_goerli");
  ...
  // ===== Polygon Mumbai ===== //
  const PolygonProvider = new ethers.providers.JsonRpcProvider("https://rpc.testnet.fantom.network");
