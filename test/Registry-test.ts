...
describe("Registry", function () {
    ...
    describe("Role", async function(){
        describe("Init Role", async function () {
            ...
            it("Has DEFAULT_ADMIN_ROLE", async function(){
                expect(await registry.hasRole(ethers.utils.keccak256(ethers.utils.toUtf8Bytes("DEFAULT_ADMIN_ROLE")),addr1.address),"Address 1 Have Not DEFAULT_ADMIN_ROLE.").to.equal(true);
            ...
            it("REGISTRAR_ROLE Admin is ADMIN_ROLE", async function(){
                expect(await registry.getRoleAdmin(ethers.utils.keccak256(ethers.utils.toUtf8Bytes("REGISTRAR_ROLE"))),"Address 1 Have Not REGISTRAR_ROLE.").to.equal(ethers.utils.keccak256(ethers.utils.toUtf8Bytes("ADMIN_ROLE")));
            })
            it("ROOT_ROLE Admin is ADMIN_ROLE", async function(){
                expect(await registry.getRoleAdmin(ethers.utils.keccak256(ethers.utils.toUtf8Bytes("ROOT_ROLE"))),"Address 1 Have Not ROOT_ROLE.").to.equal(ethers.utils.keccak256(ethers.utils.toUtf8Bytes("ADMIN_ROLE")));
            })
    ...
    describe("Domain", async function(){
        ...
        it("Create Domain",async function (){
            ...
            expect(await registry["exists(bytes32,bytes32)"](ethers.utils.keccak256(ethers.utils.toUtf8Bytes(DOMAIN)),ethers.utils.keccak256(ethers.utils.toUtf8Bytes(TLD))),"Domain Exist").to.equal(false)
            ...
            expect(await registry["exists(bytes32,bytes32)"](ethers.utils.keccak256(ethers.utils.toUtf8Bytes(DOMAIN)),ethers.utils.keccak256(ethers.utils.toUtf8Bytes(TLD))),"Domain Not Exist").to.equal(true)
        })
