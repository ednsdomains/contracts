...
async function main() {
    ...
    const BASE_REGISTRAR_IMPLEMENTATION_ADDRESS = process.env.BASE_REGISTRAR_IMPLEMENTATION_CONTRACT_ADDRESS!;
    const EDNS_REGISTRAR_CONTROLLER_ADDRESS = process.env.EDNS_REGISTRAR_CONTROLLER_CONTRACT_ADDRESS!;
    const REVERSE_REGISTRAR_ADDRESS = process.env.REVERSE_RESOLVER_CONTRACT_ADDRESS!;
    ...
    const _baseRegistrar = await upgrades.upgradeProxy(BASE_REGISTRAR_IMPLEMENTATION_ADDRESS, BaseRegistrarImplementation);
