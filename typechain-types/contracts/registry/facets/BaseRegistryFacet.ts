...
export interface BaseRegistryFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "BRIDGE_ROLE"
...
export interface BaseRegistryFacet extends BaseContract {
  connect(runner?: ContractRunner | null): BaseRegistryFacet;
