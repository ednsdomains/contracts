...
export interface AccessControlFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "BRIDGE_ROLE"
...
export interface AccessControlFacet extends BaseContract {
  connect(runner?: ContractRunner | null): AccessControlFacet;
  waitForDeployment(): Promise<this>;

  interface: AccessControlFacetInterface;
