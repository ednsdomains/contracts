...
export interface TypedTextResolverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface TypedTextResolver extends BaseContract {
  connect(runner?: ContractRunner | null): TypedTextResolver;
