...
export interface BaseResolverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface BaseResolver extends BaseContract {
  connect(runner?: ContractRunner | null): BaseResolver;
