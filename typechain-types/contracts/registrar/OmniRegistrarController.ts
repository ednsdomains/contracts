...
export interface OmniRegistrarControllerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface OmniRegistrarController extends BaseContract {
  connect(runner?: ContractRunner | null): OmniRegistrarController;
