...
export interface UniversalRegistrarControllerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface UniversalRegistrarController extends BaseContract {
  connect(runner?: ContractRunner | null): UniversalRegistrarController;
