...
export interface ClassicalRegistrarControllerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface ClassicalRegistrarController extends BaseContract {
  connect(runner?: ContractRunner | null): ClassicalRegistrarController;
