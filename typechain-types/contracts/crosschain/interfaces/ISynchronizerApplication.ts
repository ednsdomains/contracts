...
export interface ISynchronizerApplicationInterface extends Interface {
  getFunction(
    nameOrSignature: "getSynchronizer" | "receiveSync" | "setSynchronizer"
  ): FunctionFragment;

  getEvent(
    nameOrSignatureOrTopic: "ExecuteSync" | "RequestSync" | "SyncError"
  ): EventFragment;
...
export interface ISynchronizerApplication extends BaseContract {
  connect(runner?: ContractRunner | null): ISynchronizerApplication;
