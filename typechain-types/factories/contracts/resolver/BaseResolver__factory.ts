...
} from "../../../contracts/resolver/BaseResolver";
...
export class BaseResolver__factory {
  ...
  static createInterface(): BaseResolverInterface {
    return new Interface(_abi) as BaseResolverInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): BaseResolver {
    return new Contract(address, _abi, runner) as unknown as BaseResolver;
  }
}
