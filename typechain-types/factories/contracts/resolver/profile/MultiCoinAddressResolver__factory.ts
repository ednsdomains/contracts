...
} from "../../../../contracts/resolver/profile/MultiCoinAddressResolver";
...
export class MultiCoinAddressResolver__factory {
  ...
  static createInterface(): MultiCoinAddressResolverInterface {
    return new Interface(_abi) as MultiCoinAddressResolverInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as MultiCoinAddressResolver;
  }
}
