...
//         uint256 pledged; // Amount of pledged $EDNS
//         uint256 level; // Level in seconds
//         uint256 reward; // The remaining reward
//     }

//     struct PledgeMultiplier {
//         bool allow;
//         uint8 factor; // It should be a percentage, since solidity does not support floating point
//     }

//     struct LevelMultiplierTier {
//         uint8 lower; // In year, not seconds
//         uint8 upper; // In year, not seconds
//         uint8 factor; // It should be a percentage in integer format 25% => 25
//     }
...
//     /* ========== INITIALIZER  ========== */
//     function initialize(EDNSRegistrarController _controller)
//         public
//         initializer
//     {
...
//     function __AffiliateProgram_init(EDNSRegistrarController _controller)
//         internal
//         onlyInitializing
//     {
...
//     function __AffiliateProgram_init_unchained(
//         EDNSRegistrarController _controller
...
//         );
//         require(
//             _token.allowance(ownerOf(uint256(id)), address(this)) >= amount,
...
//         _token.safeTransfer(ownerOf(uint256(id)), amount);
...
//         }
//         if (_reward > 0) {
//             _token.transfer(ownerOf(uint256(id)), _reward);
//         }
...
//     function batchPayout(bytes32[] memory ids)
//         public
//         whenNotPaused
//         onlyAdminOrOperator
//     {
